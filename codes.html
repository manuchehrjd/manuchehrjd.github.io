	...
	<div class="pages">
		<div class="container">
			...
			<div class="typo-bottom">
				<div class="headdings wow fadeInLeft animated" data-wow-delay=".5s">
					<h3 class="ghj">سرفصل ها</h3>
				...
				<!--ترجمه شده توسط مرجع تخصصی برنامه نویسان-->
				<div class="Buttons wow fadeInRight animated" data-wow-delay=".5s">
					<h3 class="ghj">دکمه ها</h3>
					  <h1 class="b1">
				...
				<!--ترجمه شده توسط مرجع تخصصی برنامه نویسان-->
				<div class="progress-bars wow fadeInLeft animated" data-wow-delay=".5s">
				 <h3 class="ghj">نوار پیشرفت</h3>
				...
				<!--ترجمه شده توسط مرجع تخصصی برنامه نویسان-->
				<div class="bread-crumbs wow fadeInRight animated" data-wow-delay=".5s">
					 <h3 class="ghj">نمونه ها</h3>
					   <ol class="breadcrumb">
				...
				<div class="pagenatin wow fadeInLeft animated" data-wow-delay=".5s">
					<h3 class="ghj">صفحه بندی</h3>
						<div class="col-md-6">
						  <nav>
				...
				<div class="alerts wow fadeInRight animated" data-wow-delay=".5s">
				  <h3 class="ghj">هشدارها</h3>
				...
				<div class="distracted wow fadeInLeft animated" data-wow-delay=".5s">
				  <h3 class="ghj"></h3>
					   <div class="well">
			...
			<div class="appearance wow fadeInRight animated" data-wow-delay=".5s">
				 <h3 class="ghj">مدالها</h3>
					<div class="col-md-6">
